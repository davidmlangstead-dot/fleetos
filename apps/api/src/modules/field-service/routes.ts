...
const invoiceInput = z.object({ jobId:z.string(), customerId:z.string().uuid(), dueDate:z.coerce.date().optional(), notes:z.string().trim().max(3000).optional() });
