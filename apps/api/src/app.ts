...
import { requireCommercialWriteAccess } from "./middleware/commercialAccess.js";
...
app.use("/api/imports", sensitiveRateLimit, requireAuth, requireCommercialWriteAccess, idempotencyMiddleware, importsRouter);
...
app.use("/api/organisation", sensitiveRateLimit, requireAuth, requireCommercialWriteAccess, organisationRouter);
app.use("/api/registers", requireAuth, requireCommercialWriteAccess, idempotencyMiddleware, registersRouter);
app.use("/api/messages", requireAuth, requireCommercialWriteAccess, idempotencyMiddleware, messagesRouter);
app.use("/api/documents", sensitiveRateLimit, requireAuth, requireCommercialWriteAccess, documentsRouter);
